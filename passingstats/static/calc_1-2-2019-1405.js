...
function updateText(player)
{
    ...
    document.getElementById("ones" + index).innerHTML = "Ones: " + count[index][1];
    document.getElementById("twos" + index).innerHTML = "Twos: " + count[index][2];
    document.getElementById("threes" + index).innerHTML = "Threes: " + count[index][3];
}
